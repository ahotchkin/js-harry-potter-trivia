class User {
  ...
  instructions(user) {
    ...
    p.innerHTML = "<br>This game will be played in 7 rounds. For each round, you must answer at least 5 of 7 questions correctly to move on to the next round. If you are smart enough to get through all 7 rounds, you will vanquish Voldemort and all that he stands for. If you fail to do so, Voldemort and his followers will prevail. When in doubt, default to the books. The Wizarding World is on your shoulders. Good luck.";
