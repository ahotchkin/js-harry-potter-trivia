...
question_6 = Question.create(:round_id => 2, :content => "This is Round 2 Question 1 right here?", :answer_a => "This is Question 1 Answer A. It is incorrect.", :answer_b => "This is Question 1 Answer B. It is incorrect.", :answer_c => "This is Question 1 Answer C. It is correct.", :answer_d => "This is Question 1 Answer D. It is incorrect", :correct_answer => "C")

question_7 = Question.create(:round_id => 2, :content => "This is Round 2 Question 2 right here?", :answer_a => "This is Question 2 Answer A. It is incorrect.", :answer_b => "This is Question 2 Answer B. It is correct.", :answer_c => "This is Question 2 Answer C. It is incorrect.", :answer_d => "This is Question 2 Answer D. It is incorrect", :correct_answer => "B")

question_8 = Question.create(:round_id => 2, :content => "This is Round 2 Question 3 right here?", :answer_a => "This is Question 3 Answer A. It is incorrect.", :answer_b => "This is Question 3 Answer B. It is incorrect.", :answer_c => "This is Question 3 Answer C. It is correct.", :answer_d => "This is Question 3 Answer D. It is incorrect", :correct_answer => "C")

question_9 = Question.create(:round_id => 2, :content => "This is Round 2 Question 4 right here?", :answer_a => "This is Question 4 Answer A. It is incorrect.", :answer_b => "This is Question 4 Answer B. It is incorrect.", :answer_c => "This is Question 4 Answer C. It is incorrect.", :answer_d => "This is Question 4 Answer D. It is correct", :correct_answer => "D")

question_10 = Question.create(:round_id => 2, :content => "This is Round 2 Question 5 right here?", :answer_a => "This is Question 5 Answer A. It is correct.", :answer_b => "This is Question 5 Answer B. It is incorrect.", :answer_c => "This is Question 5 Answer C. It is incorrect.", :answer_d => "This is Question 5 Answer D. It is incorrect", :correct_answer => "A")
