...
question_16 = Question.create(:round_id => 3, :question_number => 2, :content => "How does Harry hail the night bus?", :answer_a => "By sticking his non-wand hand in the air", :answer_b => "By sticking is wand hand in the air", :answer_c => "By booking a ticket in advance", :answer_d => "By selecting the XXXL option in the Uber app", :correct_answer => "B")
